...
const UpdateIncompatibleForm = (props) => {
  const {
    params,
    saveParams,
    isUpdate,
  ...
  return (
    ...
    >
      ...
      <Form.Item name="note" label="Poisoning effect" rules={[{ required: true }]}>
        <Input.TextArea placeholder="Input poisoning effect description" rows={5} />
      </Form.Item>
    </Form>
  );
};
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateIncompatibleForm);
